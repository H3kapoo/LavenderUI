...
namespace lav::node
{
UIListView::UIListView(UIBaseInitData&& initData)
...
auto UIListView::onRender(const glm::mat4& projection) -> void
{
    /* Draw base */
    mesh_.bind();
    shader_.bind();
...
auto UIListView::calculateLayout() -> void
{
...
auto UIListView::onEvent(core::UIStatePtr& state) -> void
{
...
auto UIListView::resolveOverflow() -> void
{
    /*
...
auto UIListView::resolveVisibleItems() -> void
{
...
auto UIListView::allocatePool() -> void
{
...
auto UIListView::prepareItem(const uint32_t viewRow, std::shared_ptr<UIViewItem>& item) -> void
{
...
auto UIListView::setModel(const core::AbstractModelPtr model) -> void
{
    oldVisibleCount_ = -1;
    model_ = model;
}

auto UIListView::setRowSize(const uint32_t value) -> void
{
    rowSize_ = value;
}

auto UIListView::setAlternatingRowEnabled(const bool value) -> void
{
