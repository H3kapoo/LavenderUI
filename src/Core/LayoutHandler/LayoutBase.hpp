...
template<>
struct std::formatter<lav::core::LayoutBase::TBLR> : std::formatter<std::string_view>
{
    auto format(const lav::core::LayoutBase::TBLR& obj, format_context& ctx) const
    {
        std::ostringstream os;
...
template<>
struct std::formatter<lav::core::LayoutBase::PositionType> : std::formatter<std::string_view>
{
    auto format(const lav::core::LayoutBase::PositionType& obj, format_context& ctx) const
    {
        std::ostringstream os;
        switch(obj)
        {
            case lav::core::LayoutBase::PositionType::ABS:
                os << "ABS";
                break;
            case lav::core::LayoutBase::PositionType::COMPUTED:
                os << "COMPUTED";
                break;
            default:
                os << "UNKNOWN";
...
template<>
struct std::formatter<lav::core::LayoutBase::PositionXY> : std::formatter<std::string_view>
{
    auto format(const lav::core::LayoutBase::PositionXY& obj, format_context& ctx) const
    {
        std::ostringstream os;
...
template<>
struct std::formatter<lav::core::LayoutBase::ScaleType> : std::formatter<std::string_view>
{
    auto format(const lav::core::LayoutBase::ScaleType& obj, format_context& ctx) const
    {
        std::ostringstream os;
        switch(obj)
        {
            case lav::core::LayoutBase::ScaleType::PX:
                os << "PX";
                break;
            case lav::core::LayoutBase::ScaleType::REL:
                os << "REL";
                break;
            case lav::core::LayoutBase::ScaleType::FIT:
                os << "FIT";
                break;
            case lav::core::LayoutBase::ScaleType::FILL:
                os << "FILL";
                break;
            default:
                os << "UNKNOWN";
...
template<>
struct std::formatter<lav::core::LayoutBase::ScaleXY> : std::formatter<std::string_view>
{
    auto format(const lav::core::LayoutBase::ScaleXY& obj, format_context& ctx) const
    {
        std::ostringstream os;
        os << std::format("(({}, {}), ({}, {}))", obj.x.val, obj.x.type, obj.y.val, obj.y.type);
        return std::formatter<std::string_view>::format(std::move(os).str(), ctx);
