...
// auto BaseCalculator::calculateSplitPaneElements(node::UISplitPane* parent, const uint32_t handleIdx,
...
// auto BaseCalculator::calculateSplitPaneHandlesScale(node::UISplitPane* parent) const -> glm::vec2
// {
...
// auto BaseCalculator::calculateSplitPaneNonHandleScale(node::UISplitPane* parent,
...
// auto BaseCalculator::applySplitPaneElementsScaleCorrection(node::UISplitPane* parent,
//     const glm::vec2 handlesSize) const -> void
// {
//     const auto& elements = parent->getElements();
//     const auto& pContentScale = parent->getContentBoxScale();
...
// auto BaseCalculator::calculateSplitPaneElementsPos(node::UISplitPane* parent) const -> void
// {
//     const auto& elements = parent->getElements();
//     const auto& pLayoutType = parent->getType();
...
// auto BaseCalculator::calculateSplitPaneRelativeValuesDueToDrag(node::UISplitPane* parent,
...
auto BaseCalculator::constrainOffset(float wantedOffset,
