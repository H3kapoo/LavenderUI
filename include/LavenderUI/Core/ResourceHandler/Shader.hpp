...
public:
  ...
  auto uploadMat4v(const std::string &name,
                   const std::vector<glm::mat4> &vals) const -> void;
  ...
  auto uploadIntv(const std::string &name,
                  const std::vector<int32_t> &val) const -> void;
